...
if __name__ == "__main__":
    find_missed_detections(
        ...
        val_images_dir=config.plate_dataset_dir / "test" / "images",
        val_labels_dir=config.plate_dataset_dir / "test" / "labels",
        output_dir=config.processed_data_dir / "missed_detections_test"
    )